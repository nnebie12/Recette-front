...
const ProfilePage = () => {
  ...
  const TABS = [
    { key: 'recipes', label: `Mes recettes (${userRecipes.length})` },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card className="mb-8">
          <div className="flex items-start space-x-6">
            <div className="w-24 h-24 bg-gradient-to-br from-orange-400 to-red-500 rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex-1">
              ...
              {userBehavior?.metriques?.profilUtilisateur && (
                <span
                  className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${getProfileColor(
                    userBehavior.metriques.profilUtilisateur
                  )}`}
                >
                  {userBehavior.metriques.profilUtilisateur}
        ...
        {/* Onglet Activité — maintenant fonctionnel */}
        {activeTab === 'activity' && (
          <SearchHistoryPage />
        )}
      </div>
